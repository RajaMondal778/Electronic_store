...
<body>
    <h4 class="m-2"><?php echo $_SESSION['admin_name']; ?></h4>
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
            <h2 class="text-center m-4" style="color:green">Electronics Product</h2>
        </div>
    ...
    <div class="col-sm-4">
        <form action="db.php" method="post" enctype="multipart/form-data">
            <p>Name:
           <input type="text" name="name" placeholder="Write you name"></p>
